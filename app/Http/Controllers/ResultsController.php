...
class ResultsController extends Controller
{
    ...
    {
        if (($client == "sx2017" || $client == "sx2018" || $client == "sx2019" || $client == "ARG2018" || $client == "ARG2019" || $client == "Widney2018" || $client == "LLumar2018" || $client == "Axxess2022" || $client == "Axxess2022_2" || $client == "Axxess2023" || $client == "AIDC2022") and $id == '11') {
...
group by `11`
order by `11` desc");
        } else if (($client == "sx2017" || $client == "sx2018" || $client == "sx2019" || $client == "ARG2018" || $client == "ARG2019" || $client == "Widney2018" || $client == "LLumar2018" || $client == "Axxess2022" || $client == "Axxess2022_2" || $client == "Axxess2023" || $client == "AIDC2022") and $id == '44') {
            return DB::select("select `44` description ,count(*) count
FROM Equinox.ResultsFinal
where Engagement='" . $client . "'
group by `44`;");
        } else if ((($client == "Sheltam2017") || ($client == "Sheltam2018")) and $id == '38') {
