    ...
    <div class="container-fluid spark-screen">
        ...
        <script>
            ...
            function updateGraph() {
                ...
                var question = 1;
                var url = domain + "/results/levelaverage/site/{{ app('request')->input('site') }}/question/" + question + "/year/" + engagement + "";
                //var url = domain + "/results/levelaverage/site/{{ app('request')->input('site') }}/question/" + question + /question/ + question;
                d3.json(url, function (err, data) {
                    buildGraph(err, data, 1);
                });

                question = 2;
                url = domain + "/results/levelaverage/site/{{ app('request')->input('site') }}/question/" + question + "/year/" + engagement + "";
                ...
                question = 10;
                url = domain + "/results/levelaverage/site/{{ app('request')->input('site') }}/question/" + question + "/year/" + engagement + "";
                //url = domain + "/results/levelaverage/site/{{ app('request')->input('site') }}/question/" + question;
                d3.json(url, function (err, data) {
